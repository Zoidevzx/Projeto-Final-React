...
export default function Home() {
  ...
  return (
    <div className="container grid grid-rows-[1fr_10fr_5fr_4fr] ">
      ...
      <div className="grid grid-flow-col grid-cols-auto">
        <div><img src="item1_Home.png" alt="" className='w-[250px]' /></div>
        <div><img src="item2_Home.png" alt="" className='w-[250px]' /></div>
        <div><img src="item3_Home.png" alt="" className='w-[250px]'/></div>
      </div>

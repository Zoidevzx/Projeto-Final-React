...
export default function Home() {
  ...
  return (
    <div className="flex-center">
      <div className="container grid grid-rows-[0.7fr_5.3fr_5fr_4fr] ">
        <div className="flex justify-between">
          <div className="flex-center">
            <h1 className='m-0 p-0 font-bold text-2xl'>Urban</h1>
          </div>

          <div className="flex gap-[40px] text-xs">
            <div className="grid grid-flow-col gap-[10px] ">
              <div className="flex-center "> Home </div>
              <div className="flex-center ">About Us </div>
              <div className="flex-center gap-[3px]">Shop <ChevronDown size={12} /></div>
              <div className="flex-center border-0 gap-[3px]">Blog <ChevronDown size={12} /></div>
              <div className="flex-center gap-[3px]">Page <ChevronDown size={12} /> </div>
